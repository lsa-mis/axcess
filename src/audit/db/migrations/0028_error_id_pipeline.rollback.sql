-- Rollback for 0028. Remove error-identification probe rows before restoring
-- the prior pipeline CHECK set.

DELETE FROM page_a11y_findings WHERE pipeline = 'error_id';
